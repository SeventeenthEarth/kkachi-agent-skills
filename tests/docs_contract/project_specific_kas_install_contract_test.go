...
func TestProjectSpecificKASInstallSOTDefinesDoctorSeveritiesAndApprovalBoundary(t *testing.T) {
	requireContainsAll(t, projectSpecificKASSOT, []string{
		...
		"dry-run evidence, requires explicit approval before profile mutation",
		"never mutates auth, tokens, secrets, gateway, provider/model config, KAH state, or KAB runtime state",
		...
		"`repair-project-kas` defaults `source_pack` to `kas-default-project-suite`",
...
func TestProjectSpecificKASInstallDocsRegistrationAndRoadmap(t *testing.T) {
	requireContainsAll(t, "docs/README.md", []string{
		...
		"requires `skills/<project>/<project>-<phase-or-skill>/SKILL.md` plus project wrapper/overlay composition files",
		"generic duplicate skill names such as `kkachi-plan` are invalid",
		"umbrella-only installs are incomplete",
		"KASPROJ-002 read-only dry-run planning, KASPROJ-003 approval-hash-bound install, KASPROJ-004 doctor/repair, and KASPROJ-005 project-tailored doctor policy are implemented/in-review",
	})
	...
	requireContainsAll(t, "docs/roadmap.md", []string{
		...
		"KASPROJ-004 | Implement doctor/repair for project suites | In Review",
...
func TestProjectSpecificKASCLIContractDefinesApprovedInstallWithoutRolloutClaim(t *testing.T) {
	requireContainsAll(t, "docs/sot/kas-cli-contract.md", []string{
		...
		"Target path",
		"Drift policy",
		"The current CLI implements KASPROJ-002 read-only project-suite dry-run planning, KASPROJ-003 approval-hash-bound project-suite install, and KASPROJ-004 project-suite doctor/repair",
		...
		"`sync-project-kas`",
		"`migrate-project-kas` is removed",
		"composition_files[]",
		"install --profile <profile> --project <project> --suite-role <role> --dry-run",
		"install --project --apply",
		"install --profile <profile> --project <project> --suite-role <role> --from-generic --dry-run",
