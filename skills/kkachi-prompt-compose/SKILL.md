...
7. For implementation or feedback-handling prompts, explicitly say color-review and GLM-review fixes must be applied by the Stage 1 direct Codex SDK/app-server runner lane, Stage 2 KAB Codex implementer, or Stage 3 selected KAB implementer, not by Blue/Red/Orange/Gray direct patches.
