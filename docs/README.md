...
- Project-specific KAS install layout and naming are defined by `sot/project-specific-kas-install-contract.md`; KASPROJ-001 is in review/commit-ready as a docs/spec contract after local docs-contract evidence, while dry-run planning, approved install, doctor/repair/migrate, and one operational application step remain planned under KASPROJ.
