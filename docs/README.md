...
- `sot/kasrel-hermes-v016-provenance-contract.md` is the accepted KASREL-001 contract for release-compatibility skill provenance and dependency audit vocabulary; KASREL-002 implementation is completed/pre-commit-ready after the in-tree provenance inventory pass and required review gates, KASREL-003/004 remain planned future work, and this contract does not authorize profile mutation, production CLI implementation, or KAB activation; dependency-audit/guidance changes remain outside their tasks.
...
- Hermes release compatibility, skill provenance, shadowing, and dependency audit vocabulary are defined by `sot/kasrel-hermes-v016-provenance-contract.md`; KASREL-002 implementation is completed/pre-commit-ready, while KASREL-003/004 remain planned follow-on work.
