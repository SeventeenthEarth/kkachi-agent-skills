...
- `sot/kasrel-hermes-v016-provenance-contract.md` is the accepted KASREL-001 contract for release-compatibility skill provenance and dependency audit vocabulary; KASREL-002 implementation is completed/pre-commit-ready after the in-tree provenance inventory pass and required review gates, KASREL-003 dependency-audit implementation has current KAH run evidence and remains pending final review/KAH final gate, and KASREL-004 remains planned future work; this contract does not authorize profile mutation, production CLI implementation, or KAB activation; guidance changes remain outside KASREL-003.
...
- Hermes release compatibility, skill provenance, shadowing, and dependency audit vocabulary are defined by `sot/kasrel-hermes-v016-provenance-contract.md`; KASREL-002 implementation is completed/pre-commit-ready, KASREL-003 dependency-audit implementation is evidenced/in-review, and KASREL-004 remains planned follow-on work.
