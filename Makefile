...
test-unit:
	go test ./internal/skills/discovery ./internal/skills/install ./internal/skills/doctor ./internal/skills/graphsync ./internal/skills/kasstate ./internal/skills/projectinstall ./internal/skills/workflowtrigger
